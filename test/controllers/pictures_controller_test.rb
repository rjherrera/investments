...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { project_id: @picture.project_id, url: @picture.url } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { project_id: @picture.project_id, url: @picture.url } }
